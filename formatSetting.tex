...
% \usepackage[left=2cm, right=2.5cm, top=3.5cm, bottom=3.75cm]{geometry} %页边距
...
\setCJKfamilyfont{TimesB}[Path={font/}]{Times New Roman Bold.ttf}
\newcommand{\TimesB}{\CJKfamily{TimesB}} 
...
\titleformat*{\subsection}{\hei\zihao{-3}\centering}
\titleformat*{\subsubsection}{\hei\zihao{4}}
\titleformat*{\subsubsubsection}{\hei\zihao{-4}}
